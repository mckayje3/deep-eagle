...
def show():
    ...
    with col2:
        settings["auto_save"] = st.checkbox(
            "Auto-save configurations", value=settings.get("auto_save", True)
        )
    ...
    with col3:
        uploaded_settings = st.file_uploader(
            "Import Settings", type=["json"], key="settings_upload"
        )
    ...
    with st.expander("🔧 Advanced Settings"):
        ...
        settings["debug_mode"] = st.checkbox("Debug mode", value=settings.get("debug_mode", False))
